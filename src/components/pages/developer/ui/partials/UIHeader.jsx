                    ...
                    <div className='flex justify-between items-center sticky top-0 bg-primary py-4'>
                       <h1 className='mb-0'>BLOG</h1> 
                        <div className='flex gap-5'>
                                <button className='size-8 bg-content text-primary flex justify-center 
                                items-center rounded-lg text-sm'><FaSearch/></button>
                                <button className='text-2xl md:hidden' onClick={handleShowNav}><FaBars/></button>
                        </div>
                    </div>

                    <nav className={`${showNav ? "show" : ""} md:!max-h-[30px] md:absolute md:top-5 md:right-16`}>
                        <ul className='space-y-6 p-4 md:flex md:gap-5 md:p-0 md:space-y-0'>
                            <li><Link className="font-bold transition-color hover:text-accent 
                            active:text-accent" to="#">Home</Link></li>
                            <li><Link className="font-bold transition-color hover:text-accent" 
                            to="#">About</Link></li>
                            <li><Link className="font-bold transition-color hover:text-accent" 
                            to="#">Blog</Link></li>
